...
public class PetManager {
    ...
    /**
     * This method searches petList for a Pet object with petID and returns the object
     * If it fails to find such Pet object, it will return null
     *
     ...
     */
    public Pet createPet(String petName, int id, String petColour, String petSex, boolean publicity, String status){
